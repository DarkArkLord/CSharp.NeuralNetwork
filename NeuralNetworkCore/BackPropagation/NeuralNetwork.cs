...
namespace NeuralNetworkCore.BackPropagation
{
    [Serializable]
    public class NeuralNetwork
    {
        ...
        public static NeuralNetwork GenerateNetwork(Topology topology, DataSet[] data, double max_error = 1.0e-5, double min_delta_error = 1.0e-20)
        {
